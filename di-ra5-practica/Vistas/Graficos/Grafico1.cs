    ...
    public partial class Grafico1 : Form
    {
        ...
        private void Grafico1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = Path.Combine(projectDir, "Reportes", "ReportGraficosCompras1.rdlc");
                reportPath = Path.GetFullPath(reportPath);

                this.reportViewer1.LocalReport.ReportPath = reportPath;
                this.reportViewer1.LocalReport.DataSources.Clear();
                this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("GraficosCompras", compras));
