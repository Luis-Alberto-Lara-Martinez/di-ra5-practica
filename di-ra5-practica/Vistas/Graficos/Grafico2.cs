...
{
    public partial class Grafico2 : Form
    {
        public Grafico2()
        {
            InitializeComponent();
        ...
        private void Grafico2_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = Path.Combine(projectDir, "Reportes", "ReportGraficosProductos1.rdlc");
