...
{
    public partial class Grafico3 : Form
    {
        public Grafico3()
        {
            InitializeComponent();
        ...
        private void Grafico3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = Path.Combine(projectDir, "Reportes", "ReportGraficosCompras2.rdlc");
