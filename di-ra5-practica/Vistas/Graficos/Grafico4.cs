...
{
    public partial class Grafico4 : Form
    {
        public Grafico4()
        {
            InitializeComponent();
        ...
        private void Grafico4_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = Path.Combine(projectDir, "Reportes", "ReportGraficosProductos2.rdlc");
