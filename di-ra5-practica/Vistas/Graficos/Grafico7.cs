...
{
    public partial class Grafico7 : Form
    {
        public Grafico7()
        {
            InitializeComponent();
        ...
        private void Grafico7_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string reportPath = Path.Combine(projectDir, "Reportes", "ReportGraficosProductos3.rdlc");
